events = {
    'start' browser: true, namespace: 'browser';
    'end' browser: true, namespace: 'browser';
    'endSegment' browser: true, namespace: 'browser';
    'loadingProgress' browser:true, namespace: 'browser';
    'spaceStartLoading' browser:true, namespace: 'browser';
