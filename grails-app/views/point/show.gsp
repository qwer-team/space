	...
	<body>
		...
		<div id="show-point" class="content scaffold-show" role="main">
			...
			<ol class="property-list point">
				...
				<g:if test="${pointInstance?.name}">
				<li class="fieldcontain">
					<span id="name-label" class="property-label"><g:message code="point.name.label" default="Name" /></span>
					
						<span class="property-value" aria-labelledby="name-label"><g:fieldValue bean="${pointInstance}" field="name"/></span>
				...
				<li class="fieldcontain">
					<span id="type-label" class="property-label"><g:message code="point.type.label" default="Type" /></span>
						...
						<span class="property-value" aria-labelledby="type-label"><g:fieldValue bean="${pointInstance}" field="type"/></span>
